            ...
            <div className="col-lg-7">
              <div className="about-content-part rel z-2 rmb-55">
                <div className="section-title mb-35 wow fadeInUp delay-0-2s">
                  ...
                  <h2>
				  	Full-Stack Web Developer Specializing in <span>PHP Laravel</span> & Next.js, Vue, and React
                  </h2>
                  <p>
				  	I am a versatile full-stack web developer with extensive experience in creating scalable, high-performance web applications. My expertise spans across backend frameworks like PHP Laravel, modern frontend technologies like Next.js, Vue.js, and React, and robust server configuration for secure and efficient deployments. I am committed to delivering tailored solutions that meet the unique needs of your project while ensuring seamless performance and user experience.
                  </p>
                </div>
